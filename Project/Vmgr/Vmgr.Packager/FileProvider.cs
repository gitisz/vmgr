...
namespace Vmgr.Packager
{
    public partial class FileProvider
    {
        ...
        public static bool IncludeFile(FileInfo file)
        {
            ...
            if (file.Name.Equals("Vmgr.dll", StringComparison.InvariantCultureIgnoreCase))
            {
                return false;
            }

            if (file.Name.Equals("Vmgr.NET40.dll", StringComparison.InvariantCultureIgnoreCase))
            {
                return false;
            }

            if (file.Name.Equals("Vmgr.NET35.dll", StringComparison.InvariantCultureIgnoreCase))
            {
                return false;
            }

            if (file.Name.Equals("Quartz.dll", StringComparison.InvariantCultureIgnoreCase))
            {
                return false;
            }

            if (file.Name.Equals("Common.Logging.dll", StringComparison.InvariantCultureIgnoreCase))
            {
                return false;
            }

            if (file.Name.Equals("C5.dll", StringComparison.InvariantCultureIgnoreCase))
            {
                return false;
            }
