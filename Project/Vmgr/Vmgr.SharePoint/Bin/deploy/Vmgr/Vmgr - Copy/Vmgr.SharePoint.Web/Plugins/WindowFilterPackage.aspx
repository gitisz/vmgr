...
<%@ Page    
    ...
    CodeBehind="WindowFilterPackage.aspx.cs" 
    Inherits="Vmgr.SharePoint.Plugins.WindowFilterPackage, Vmgr.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d83f0fbbbc9139fe" 
    %>
<%@ Register TagPrefix="Vmgr" TagName="FilterPackageControl" Src="~/_CONTROLTEMPLATES/Vmgr/FilterPackageControl.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <Vmgr:FilterPackageControl 
        runat="server"
        ID="FilterPackageControl" 
        >
    </Vmgr:FilterPackageControl>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderFooterContent" runat="server">
    <div style="text-align: center; width: 100%;">
        <table border="0" style="margin: 0px auto; padding: 0px;">
            <tr>
                <td>
                    <telerik:RadButton 
                        runat="server" 
