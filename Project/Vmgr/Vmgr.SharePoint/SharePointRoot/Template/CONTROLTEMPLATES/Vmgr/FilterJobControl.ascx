...
<%@ Control 
    ...
    CodeBehind="FilterJobControl.ascx.cs" 
    Inherits="Vmgr.SharePoint.FilterJobControl, Vmgr.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d83f0fbbbc9139fe" 
    %>
<%@ Register 
            ...
            <tr>
                ...
                <td style="vertical-align: top; padding: 5px;">
                    <fieldset style="padding: 10px;">
                        <legend style="font-size: 9pt;">My Job Filters</legend>
                        <asp:LinqDataSource
                            runat="server"
