...
{
    public partial class FilterPackageControl : BaseControl
    {
        ...
        private void DeleteFilter(int filterId)
        {
            ...
            this.filter.LoadSettings(PACKAGE_UNDO_NEW_FILTER);
        ...
        private void Save()
        {
            ...
            myFilter.FilterType = FilterType.Package.ToString();
        ...
        public const string PACKAGE_UNDO_NEW_FILTER = "";
        ...
        public static void PopulateFilterFields(RadFilter filter)
        {
            ...
            filter.FieldEditors.Add(new RadFilterNumericFieldEditor { DataType = typeof(System.Int32), FieldName = "PackageId", DisplayName = "Package ID" });
            filter.FieldEditors.Add(new RadFilterTextFieldEditor { DataType = typeof(System.String), FieldName = "Name", DisplayName = "Package Name" });
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            FilterPackageControl.PopulateFilterFields(this.filter);
        }
        ...
        {
            string dlinq = FilterPackageControl.DecodeLinqFilterExpression(e.ExpressionRoot);
            string preview = FilterPackageControl.DecodePreviewFilterExpression(this.filter.RootGroup, filter);
