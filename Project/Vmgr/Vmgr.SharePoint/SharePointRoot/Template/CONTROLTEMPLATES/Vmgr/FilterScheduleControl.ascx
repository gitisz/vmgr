...
<%@ Control 
    ...
    CodeBehind="FilterScheduleControl.ascx.cs" 
    Inherits="Vmgr.SharePoint.FilterScheduleControl, Vmgr.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d83f0fbbbc9139fe" 
    %>
<%@ Register 
...
<telerik:RadAjaxLoadingPanel 
    runat="server"
    ID="ajaxLoadingPanelScheduleManager" 
    Skin="Default" 
    ZIndex="2999"
    ></telerik:RadAjaxLoadingPanel>
            ...
            <tr>
                ...
                <td style="vertical-align: top; padding: 5px;">
                    <fieldset style="padding: 10px;">
                        <legend style="font-size: 9pt;">My Schedule Filters</legend>
                        <asp:LinqDataSource
                            runat="server"
