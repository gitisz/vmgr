...
<telerik:RadCodeBlock runat="server">
    <script type="text/javascript">
        ...
        function OnScheduleRequestStart(s, e) {
        }
...
<telerik:RadAjaxPanel
    ...
    ClientEvents-OnRequestStart="OnScheduleRequestStart"
    >
    <asp:LinqDataSource
        runat="server"
                        ...
                        <tr>
                            <td style="border-collapse: collapse; vertical-align: top; padding: 0px;">
                                <telerik:RadGrid 
                                    ...
                                    OnPreRender="gridSchedule_PreRender"
                                    OnPageIndexChanged="gridSchedule_PageIndexChanged"
                                    OnPageSizeChanged="gridSchedule_PageSizeChanged"
                                    >
                                    <MasterTableView 
                                        AllowPaging="true" 
                                        AllowCustomPaging="true"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Panel
                                                                    ...
                                                                    ID="panelPackage"
                                                                    Visible="false"
                                                                    style="padding: 2px; font-style:italic; color: #999;"
                                                                    >
                                                                    This plugin belongs to a package that is paused.  
                                                                    <asp:HyperLink
                                                                        runat="server"
                                                                        ID="hyperLinkChangeThat"
