...
<%@ Page    
    ...
    CodeBehind="WindowSecurityMembershipEditor.aspx.cs" 
    Inherits="Vmgr.SharePoint.WindowSecurityMembershipEditor, Vmgr.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d83f0fbbbc9139fe" 
    %>
...
<%@ Register TagPrefix="Vmgr" TagName="SecurityMembershipEditorControl" Src="~/_CONTROLTEMPLATES/Vmgr/SecurityMembershipEditorControl.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <Vmgr:SecurityMembershipEditorControl 
        runat="server"
