...
<%@ Page    
    ...
    CodeBehind="WindowSecurityRolePermissionEditor.aspx.cs" 
    Inherits="Vmgr.SharePoint.WindowSecurityRolePermissionEditor, Vmgr.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d83f0fbbbc9139fe" 
    %>
...
<%@ Register TagPrefix="Vmgr" TagName="SecurityRolePermissionEditorControl" Src="~/_CONTROLTEMPLATES/Vmgr/SecurityRolePermissionEditorControl.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <Vmgr:SecurityRolePermissionEditorControl 
        runat="server"
