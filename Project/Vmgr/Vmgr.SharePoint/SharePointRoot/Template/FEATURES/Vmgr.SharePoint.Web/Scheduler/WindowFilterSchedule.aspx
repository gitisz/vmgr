...
<%@ Page    
    ...
    CodeBehind="WindowFilterSchedule.aspx.cs" 
    Inherits="Vmgr.SharePoint.WindowFilterSchedule, Vmgr.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d83f0fbbbc9139fe" 
    %>
<%@ Register TagPrefix="Vmgr" TagName="FilterScheduleControl" Src="~/_CONTROLTEMPLATES/Vmgr/FilterScheduleControl.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <Vmgr:FilterScheduleControl 
        runat="server"
        ID="FilterScheduleControl" 
        >
    </Vmgr:FilterScheduleControl>
</asp:Content>
