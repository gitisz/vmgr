...
namespace Vmgr.Data.Biz.MetaData
{
    ...
    public partial class SecurityMembershipMetaData : IMetaData
    {	
		[Key]
        public virtual System.Int32 SecurityMembershipId { get; set; }
        public virtual System.String Account { get; set; }
        public virtual System.Int32 AccountType { get; set; }
