...
namespace Vmgr.Data.Generic.FactoryClasses
{
	...
	{
		private static readonly Dictionary<Vmgr.Data.Generic.EntityType, string> _entityTypeNamesCache = new Dictionary<Vmgr.Data.Generic.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(Vmgr.Data.Generic.EntityType value in Enum.GetValues(typeof(Vmgr.Data.Generic.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(Vmgr.Data.Generic.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(Vmgr.Data.Generic.EntityType relatedEntityType)
		{
